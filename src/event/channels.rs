    ...
    pub fn empty_channels(&self) -> std::result::Result<(), crossbeam_channel::RecvError> {
        loop {
            crossbeam_channel::select! {
                recv(self.activities_join) -> e => trace!("dropping event: {:?}", e?),
                recv(self.activities_spectate) -> e => trace!("dropping event: {:?}", e?),
                recv(self.activities_request) -> e => trace!("dropping event: {:?}", e?),
                recv(self.activities_invite) -> e => trace!("dropping event: {:?}", e?),
                recv(self.lobbies_update) -> e => trace!("dropping event: {:?}", e?),
                recv(self.lobbies_delete) -> e => trace!("dropping event: {:?}", e?),
                recv(self.lobbies_member_connect) -> e => trace!("dropping event: {:?}", e?),
                recv(self.lobbies_member_update) -> e => trace!("dropping event: {:?}", e?),
                recv(self.lobbies_member_disconnect) -> e => trace!("dropping event: {:?}", e?),
                recv(self.lobbies_message) -> e => trace!("dropping event: {:?}", e?),
                recv(self.lobbies_speaking) -> e => trace!("dropping event: {:?}", e?),
                recv(self.lobbies_network_message) -> e => trace!("dropping event: {:?}", e?),
                recv(self.networking_message) -> e => trace!("dropping event: {:?}", e?),
                recv(self.networking_route_update) -> e => trace!("dropping event: {:?}", e?),
                recv(self.overlay_toggle) -> e => trace!("dropping event: {:?}", e?),
                recv(self.relationships_refresh) -> e => trace!("dropping event: {:?}", e?),
                recv(self.relationships_update) -> e => trace!("dropping event: {:?}", e?),
                recv(self.store_entitlement_create) -> e => trace!("dropping event: {:?}", e?),
                recv(self.store_entitlement_delete) -> e => trace!("dropping event: {:?}", e?),
                recv(self.current_user_update) -> e => trace!("dropping event: {:?}", e?),
                recv(self.voice_settings_update) -> e => trace!("dropping event: {:?}", e?),
                default => return Ok(())
            }
        }
    }
