...
pub(crate) struct Receivers {
    pub(crate) achievements_update: Receiver<event::achievements::Update>,
    pub(crate) activities_join: Receiver<event::activities::Join>,
    pub(crate) activities_spectate: Receiver<event::activities::Spectate>,
    pub(crate) activities_request: Receiver<event::activities::Request>,
    pub(crate) activities_invite: Receiver<event::activities::Invite>,
    pub(crate) lobbies_update: Receiver<event::lobbies::Update>,
    pub(crate) lobbies_delete: Receiver<event::lobbies::Delete>,
    pub(crate) lobbies_member_connect: Receiver<event::lobbies::MemberConnect>,
    pub(crate) lobbies_member_update: Receiver<event::lobbies::MemberUpdate>,
    pub(crate) lobbies_member_disconnect: Receiver<event::lobbies::MemberDisconnect>,
    pub(crate) lobbies_message: Receiver<event::lobbies::Message>,
    pub(crate) lobbies_speaking: Receiver<event::lobbies::Speaking>,
    pub(crate) lobbies_network_message: Receiver<event::lobbies::NetworkMessage>,
    pub(crate) networking_message: Receiver<event::networking::Message>,
    pub(crate) networking_route_update: Receiver<event::networking::RouteUpdate>,
    pub(crate) overlay_toggle: Receiver<event::overlay::Toggle>,
    pub(crate) relationships_refresh: Receiver<event::relationships::Refresh>,
    pub(crate) relationships_update: Receiver<event::relationships::Update>,
    pub(crate) store_entitlement_create: Receiver<event::store::EntitlementCreate>,
    pub(crate) store_entitlement_delete: Receiver<event::store::EntitlementDelete>,
    pub(crate) current_user_update: Receiver<event::users::CurrentUserUpdate>,
    pub(crate) voice_settings_update: Receiver<event::voice::SettingsUpdate>,
}
