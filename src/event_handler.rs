...
pub trait EventHandler {
    ...
    fn on_activity_join(&mut self, discord: &Discord, secret: &str) {}
    ...
    fn on_activity_spectate(&mut self, discord: &Discord, secret: &str) {}
    ...
    fn on_lobby_update(&mut self, discord: &Discord, lobby_id: LobbyID) {}

    /// Fired when a lobby is deleted.
    ///
    /// > [Method in official docs](https://discordapp.com/developers/docs/game-sdk/lobbies#onlobbydelete)
    fn on_lobby_delete(&mut self, discord: &Discord, lobby_id: LobbyID, reason: u32) {}
    ...
    fn on_member_connect(&mut self, discord: &Discord, lobby_id: LobbyID, member_id: UserID) {}
    ...
    fn on_member_update(&mut self, discord: &Discord, lobby_id: LobbyID, member_id: UserID) {}
    ...
    fn on_member_disconnect(&mut self, discord: &Discord, lobby_id: LobbyID, member_id: UserID) {}
    ...
    fn on_network_route_update(&mut self, discord: &Discord, route: &str) {}
    ...
    fn on_overlay_toggle(&mut self, discord: &Discord, closed: bool) {}
    ...
    fn on_relationship_update(&mut self, discord: &Discord, relationship: &Relationship) {}
    ...
    fn on_entitlement_create(&mut self, discord: &Discord, entitlement: &Entitlement) {}
    ...
    fn on_entitlement_delete(&mut self, discord: &Discord, entitlement: &Entitlement) {}
